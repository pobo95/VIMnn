...
def _start_summary(
    *,
    ...
    return TrainingStartSummary(
        ...
        energy_normalization=config.loss.energy_normalization,
        gradient_clip_norm=config.train_step.gradient_clip_norm,
        ...
        early_stop_relative_delta=config.selection.relative_min_delta,
